import type { PayrollListColumnProps } from "./columns";

export const PAYROLL_LIST:PayrollListColumnProps[] = [
  {
    id: "1",
    employee: "علی رضایی",
    employeeId: "EMP001",
