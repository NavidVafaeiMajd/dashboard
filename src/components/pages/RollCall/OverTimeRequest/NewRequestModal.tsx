      ...
      <AnimatePresence>
         {open && (
            <motion.div
               ...
               animate={{ opacity: 1 }}
               exit={{ opacity: 0 }}
               className="bg-black/25 fixed grid inset-0 z-100 overflow-y-auto items-center justify-center"
            >
               <motion.div
               ...
               >
                  <div>
                     <div className="flex justify-between ">
                        ...
                        <div className="flex flex-col items-center justify-center text-center mb-4">
                           <h1 className="text-cupurple text-xl ">
                  ...
                  <Form {...form}>
                     ...
                     >
                           ...
                           render={() => (
                              <FormItem className="w-full space-y-2">
                                 ...
                                 <FormControl>
                                    <Input
                                       disabled
                                       placeholder="کامپوننت تاریخ جایگزین شود"
                        ...
                        />
                        <div className="flex flex-col gap-x-5 md:flex-row space-y-2 md:space-y-0">
                           <FormField
                              control={form.control}
                              name="entryDate"
                              render={() => (
                                 <FormItem className="w-full space-y-2">
                                    ...
                                    <FormControl>
                                       <div className="flex items-center">
                                          <Input
                                             disabled
                                             placeholder="کامپوننت زمان جایگزین شود"
                                             className="w-full border rounded p-2 min-h-12"
                                          />
